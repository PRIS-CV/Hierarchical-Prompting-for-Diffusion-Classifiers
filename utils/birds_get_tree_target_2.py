...
df = pd.read_csv('prompts/Birds_name.csv')
...
def get_order_name():
    ...
    for data in trees_order_to_species:
        first_species = data[1]
        order_name = df.loc[df['idx'] == first_species, 'order'].values[0]
...
def get_family_name():
    ...
    for data in trees_family_to_species:
        first_species = data[1]
        family_name = df.loc[df['idx'] == first_species, 'family'].values[0]
